...
live Nexus pages on **2026-09-05** (game patch 7.0.2); **current pack: 2026.09.12-r8**. The per-mod audit with dates
...
| Weapons | [Custom Scopes Compendium: Attachment Remover](https://www.nexusmods.com/helldivers2/mods/443) | Hides every stock sight and attachment model (the Clone Blasters author's own fix for floating optics). Always included in both modded modes; Spear and Wasp scopes stay. |

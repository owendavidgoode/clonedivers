...
public static class SupportHistory
{
    ...
    static string SafeCategory(string category) => category is "none reported" or "GameGuard 114 reported" or "GameGuard 110 reported" or "disk space" or "file integrity" or "download or network" or "file access" ? category : "reported (message omitted for privacy)";
}
